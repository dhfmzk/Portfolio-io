...
namespace Utils
{
    ...
    public class MonoBehaviourSingleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        {
            Print(global::UnityEngine.Debug.Log, PrintTrace, str, args);
        }

        protected void PrintWarn(string str, params object[] args)
        {
            Print(global::UnityEngine.Debug.LogWarning, PrintTrace, str, args);
        }

        protected void PrintError(string str, params object[] args)
        {
            Print(global::UnityEngine.Debug.LogError, PrintTrace, str, args);
        }
